...
- Clean the data set including convert variables format and check missing data.
...
- Build a linear regression model with variables of the initial selection, the  use regsubset function to choose a best model of the subsets by maximizing adjusted r2 and minimizing Cp and BIC.
